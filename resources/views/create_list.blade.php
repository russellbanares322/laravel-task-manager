...
<body>
    <div class="container create_cont">
        ...
        <form action="save_list">
            <textarea type="text" name='name' placeholder="Input task" class="form-control"> </textarea>
            <button type="submit" value='save' class="btn btn-primary mt-4 mb-5 save">Create<i class="fas fa-plus-circle pl-2"></i></button>
        </form>
    </div>
